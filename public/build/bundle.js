    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1bfo2hm");
    			add_location(img, file$9, 16, 6, 502);
    			attr_dev(div0, "class", "about__img animate__animated svelte-1bfo2hm");
    			attr_dev(div0, "id", "left_animate");
    			add_location(div0, file$9, 15, 4, 434);
    			attr_dev(h21, "class", "about__subtitle svelte-1bfo2hm");
    			add_location(h21, file$9, 19, 6, 609);
    			add_location(br0, file$9, 21, 34, 735);
    			attr_dev(span0, "class", "about__profesion-plus svelte-1bfo2hm");
