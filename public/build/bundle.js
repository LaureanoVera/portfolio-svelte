    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$9, 21, 34, 735);
    			attr_dev(span, "class", "about__profession svelte-1ahmov8");
    			add_location(span, file$9, 20, 6, 667);
    			add_location(br1, file$9, 27, 28, 998);
    			attr_dev(p, "class", "about__text svelte-1ahmov8");
    			add_location(p, file$9, 24, 6, 784);
    			attr_dev(h3, "class", "about__hobbies svelte-1ahmov8");
    			add_location(h3, file$9, 30, 6, 1090);
    			add_location(li0, file$9, 32, 8, 1151);
    			add_location(li1, file$9, 33, 8, 1185);
    			add_location(li2, file$9, 34, 8, 1214);
    			add_location(ul, file$9, 31, 6, 1137);
    			attr_dev(i1, "class", "fab fa-linkedin-in");
    			add_location(i1, file$9, 40, 37, 1435);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "footer__image svelte-nxmm4h");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main1, file, 6, 0, 169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
