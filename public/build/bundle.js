...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$5, 12, 4, 328);
    			attr_dev(h20, "class", "section-title");
    			add_location(h20, file$5, 11, 2, 296);
    			...
    			add_location(img, file$5, 16, 6, 502);
    			attr_dev(div0, "class", "about__img animate__animated svelte-1ahmov8");
    			attr_dev(div0, "id", "left_animate");
    			add_location(div0, file$5, 15, 4, 434);
    			attr_dev(h21, "class", "about__subtitle svelte-1ahmov8");
    			add_location(h21, file$5, 19, 6, 609);
    			add_location(br0, file$5, 21, 34, 735);
    			attr_dev(span, "class", "about__profession svelte-1ahmov8");
    			add_location(span, file$5, 20, 6, 667);
    			add_location(br1, file$5, 27, 28, 998);
    			attr_dev(p, "class", "about__text svelte-1ahmov8");
    			add_location(p, file$5, 24, 6, 784);
    			attr_dev(h3, "class", "about__hobbies svelte-1ahmov8");
    			add_location(h3, file$5, 30, 6, 1090);
    			add_location(li0, file$5, 32, 8, 1151);
    			add_location(li1, file$5, 33, 8, 1185);
    			add_location(li2, file$5, 34, 8, 1214);
    			add_location(ul, file$5, 31, 6, 1137);
    			attr_dev(i1, "class", "fab fa-linkedin-in");
    			add_location(i1, file$5, 40, 37, 1435);
    ...
    const file$3 = "src\\components\\TimeLineItem.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$3, 13, 8, 287);
    		},
    		m: function mount(target, anchor) {
    ...
    class TimeLineItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { date: 0, name: 1, list: 2 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 52, 4, 1123);
    			attr_dev(h2, "class", "section-title");
    			add_location(h2, file$2, 51, 2, 1091);
    			attr_dev(div, "class", "timeline__items svelte-gwdscf");
    			add_location(div, file$2, 54, 2, 1186);
    			attr_dev(section, "class", "timeline section svelte-gwdscf");
    			attr_dev(section, "id", "education");
    			add_location(section, file$2, 50, 0, 1038);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 7, 0, 187);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Home, About, Skills, Education });
    	return [];
    }
